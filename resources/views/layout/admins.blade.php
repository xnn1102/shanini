	...
	<div id="mws-header" class="clearfix">
    	...
    	<div id="mws-logo-container">
        	...
        	<div id="mws-logo-wrap">
                <h3 style='color:white'>PHP29网站</h3>
			</div>
        </div>
        ...
        <div id="mws-user-tools" class="clearfix">
            ...
            <div id="mws-user-info" class="mws-inset">
            	...
            	<div id="mws-user-photo">
                	<img src="{{$data->profile}}" alt="User Photo">
                </div>
                
                <!-- Username and Function s -->
                <div id="mws-user-functions">
                    ...
                    <ul>
                        ...
                        <li><a href="/admin/changepass/{{$data->id}}">修改密码</a></li>
        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                <ul>
                  ...
                  <ul>
                    <li>
                        <a href="#"><i class="icon-paper-airplane"></i>轮播图管理</a>
                        <ul class='closed'>
                            <li><a href="/admin/user/create">添加轮播图</a></li>
