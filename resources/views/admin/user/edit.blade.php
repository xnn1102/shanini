    	...
    	<form action="/admin/user/{{$res->id}}" method='post' enctype='multipart/form-data' class="mws-form">
    		<div class="mws-form-inline">
    			...
    			<div class="mws-form-row">
    				...
    				<div class="mws-form-item">
    					<img src="{{$res->profile}}" alt="" width="200px" height="200">
    			...
    			<div class="mws-form-row">
    				...
    				<div class="mws-form-item clearfix">
    					<ul class="mws-form-list inline">
    						...
    						<li><input type="radio" name='status' value='1' @if($res->status == 1) checked='checked' @endif> <label>开启</label></li>


    						<li><input type="radio" name='status' value='0' @if($res->status == 0) checked='checked'@endif> <label>禁用</label></li>
